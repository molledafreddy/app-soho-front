      ...
      <div class="container">
        <ul class="nav">
          ...
          <li class="nav-item with-sub ">
            <a :class="'bg-'+color.bg" class="nav-link tx-white" href="#" >
              <i class="icon ion-ios-home-outline" :class="'tx-'+color.home"></i>
              <span>{{trans('app.navbar.dashboard')}}</span>
            </a>
            <div class="sub-item">
              <ul>
          ...
          <li class="nav-item with-sub mega-dropdown">
            <a class="nav-link " href="#">
              <i class="icon ion-ios-filing-outline " :class="'tx-'+color.tx" ></i>
              <span>{{trans('app.navbar.ui_elements')}}</span>
            </a>
            <div class="sub-item">
              <div class="row">
                <div class="col-lg-5">
          ...
          <li class="nav-item with-sub">
            <a class="nav-link" href="#">
              <i class="icon ion-ios-book-outline" :class="'tx-'+color.tx"></i>
              <span>{{trans('app.navbar.pages')}}</span>
            </a>
            <div class="sub-item">
              <ul>
          ...
          <li class="nav-item with-sub">
            <a class="nav-link" href="#" data-toggle="dropdown">
              <i class="icon ion-ios-gear-outline" :class="'tx-'+color.tx"></i>
              <span>{{trans('app.navbar.forms')}}</span>
            </a>
            <div class="sub-item">
              <ul>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              <i class="icon ion-ios-chatboxes-outline" :class="'tx-'+color.tx"></i>
              <span>{{trans('app.navbar.messages')}}</span>
              <span class="square-8" :class="'bg-'+color.tx"></span>
            </a>
          </li>
          <li class="nav-item with-sub">
            <a class="nav-link" href="#">
              <i class="icon ion-ios-book-outline" :class="'tx-'+color.tx"></i>
              <span>{{trans('app.navbar.admin')}}</span>
            </a>
            <div class="sub-item">
              <ul>
                <li><a @click="home" href="#">{{trans('app.navbar.home')}}</a></li>
                <li><a @click="users" href="#">{{trans('app.navbar.users')}}</a></li>
                <li><a @click="settingGroup" href="#">{{trans('app.navbar.setting_groups')}}</a></li>
                <li><a @click="settings" href="#">{{trans('app.navbar.settings')}}</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </li>
        </ul>
...
<style>
    ...
    .bg-info {
    background-color: #171e63 !important; }
    .bd-info {
    border-color: #171e63 !important; }
    .bg-pink {
